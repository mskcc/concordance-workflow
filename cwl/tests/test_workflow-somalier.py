...
# -*- coding: utf-8 -*-
"""
unit tests for the workflow-somalier.cwl file
"""
import shutil
import os
import csv
...
from settings import CWL_DIR, DATA_SETS, CWL_ARGS, REF_FASTA, SOMALIER_SITES

cwl_file = os.path.join(CWL_DIR, 'workflow-somalier.cwl')

class TestSomalierWorkflowCWL(unittest.TestCase):
